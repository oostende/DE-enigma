...
#DE Patch
from DE.DEManager import DEManagerOpen
from DE.DEManager import DEPluginsPanelOpen

class InfoBar(InfoBarBase, InfoBarShowHide,
	InfoBarNumberZap, InfoBarChannelSelection, InfoBarMenu, InfoBarEPG, InfoBarRdsDecoder,DEManagerOpen, DEPluginsPanelOpen, 
